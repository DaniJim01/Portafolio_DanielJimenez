package TechShop.Daniel.controller;
import TechShop.Daniel.domain.Producto;
import TechShop.Daniel.service.CategoriaService; // ← agregar import
import TechShop.Daniel.service.ProductoService;
...
public class ProductoController {
    ...
    public String listado(Model model) {
        ...
        var categorias = categoriaService.getCategorias(true); // ← líneas 36-37
    ...
    public String modificar(@PathVariable("idProducto") Integer idProducto, Model model, RedirectAttributes redirectAttributes) {
        ...
        var categorias = categoriaService.getCategorias(true); // ← líneas 81-82
        model.addAttribute("categorias", categorias);
